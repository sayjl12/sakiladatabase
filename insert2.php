...
if($conn->connect_error){
	...
	$sql = "INSERT INTO category (category_id, name, last_update) VALUES ('".$_POST["catid"]."','".$_POST["name"]."','$date');";
	$sql .= "UPDATE category SET last_update='$date' WHERE category_id IS NOT NULL";
