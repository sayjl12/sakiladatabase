...
<form action="search2.php" method="post">
	...
	<option value="catid">Category ID</option>
...
<div id="insert" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container">
        <p><label><i class="fa fa-id-card"></i> Category ID</label></p>
        <input class="w3-input w3-border" type="text" name="catid" placeholder="Enter New ID">
        <p><label><i class="fa fa-user"></i> Category Name</label></p>
        <input class="w3-input w3-border" type="text" name="name" placeholder="Enter First Name">
