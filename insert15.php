...
if($conn->connect_error){
	...
	$sql = "INSERT INTO store (store_id, manager_staff_id, address_id,last_update) VALUES ('".$_POST["storeid"]."','".$_POST["managerid"]."', '".$_POST["addid"]."','$date');";
	$sql .= "UPDATE store SET last_update='$date' WHERE store_id IS NOT NULL";
