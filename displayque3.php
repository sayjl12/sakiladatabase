...
<div id="insert" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container">
        <p><label><i class="fa fa-id-card"></i> City ID</label></p>
        <input class="w3-input w3-border" type="text" name="cityid" placeholder="Enter New ID">
        <p><label><i class="fa fa-user"></i> City Name</label></p>
        <input class="w3-input w3-border" type="text" name="city" placeholder="Enter First Name">
		<p><label><i class="fa fa-user"></i> Country ID</label></p>
        <input class="w3-input w3-border" type="text" name="countryid" placeholder="Enter Last Name">
