...
if($conn->connect_error){
	...
	$sql = "INSERT INTO language (language_id, name, last_update) VALUES ('".$_POST["langid"]."','".$_POST["langname"]."', '$date');";
	$sql .= "UPDATE language SET last_update='$date' WHERE language_id IS NOT NULL";
