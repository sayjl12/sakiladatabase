<html>
<form action="search14.php" method="post">
...
<div id="insert" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container">
        <p><label><i class="fa fa-id-card"></i> Staff ID</label></p>
        <input class="w3-input w3-border" type="text" name="staffid" placeholder="Enter New ID">
        <p><label><i class="fa fa-user"></i> First Name</label></p>
        <input class="w3-input w3-border" type="text" name="fname" placeholder="Enter First Name">
        ...
        <input class="w3-input w3-border" type="text" name="username" placeholder="Enter Last Name">
        <p><label><i class="fa fa-user"></i> Password</label></p>
        <input class="w3-input w3-border" type="text" name="password" placeholder="Enter Last Name">
