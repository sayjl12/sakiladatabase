<html>
<form action="search15.php" method="post">
...
<div id="insert" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container">
        <p><label><i class="fa fa-id-card"></i> Store ID</label></p>
        <input class="w3-input w3-border" type="text" name="storeid" placeholder="Enter New ID">
        <p><label><i class="fa fa-user"></i> Manager ID</label></p>
        <input class="w3-input w3-border" type="text" name="managerid" placeholder="Enter First Name">
