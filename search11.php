...
switch($svalue){
	case 'langid':
		$sql = "SELECT * FROM language WHERE language_id LIKE '%{$textinput}%'";
		$result = $conn->query($sql);
	break;
	case 'langname':
		$sql = "SELECT * FROM language WHERE name LIKE '%{$textinput}%'";
		$result = $conn->query($sql);
	break;
}
echo "
