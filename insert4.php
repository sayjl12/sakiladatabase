...
if($conn->connect_error){
	...
	$sql = "INSERT INTO country (country_id, country,last_update) VALUES ('".$_POST["cusid"]."','".$_POST["country"]."', '$date');";
	$sql .= "UPDATE country SET last_update='$date' WHERE country_id IS NOT NULL";
