...
if($conn->connect_error){
	...
	$sql = "INSERT INTO city (city_id, city, country_id, last_update) VALUES ('".$_POST["cityid"]."','".$_POST["city"]."', '".$_POST["countryid"]."', '$date');";
	$sql .= "UPDATE city SET last_update='$date' WHERE city_id IS NOT NULL";
