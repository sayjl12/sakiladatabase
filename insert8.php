...
if($conn->connect_error){
	...
	$sql = "INSERT INTO film_category (film_id, category_id, last_update) VALUES ('".$_POST["filmid"]."','".$_POST["catid"]."','$date');";
	$sql .= "UPDATE film_category SET last_update='$date' WHERE film_id IS NOT NULL";
