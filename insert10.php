...
if($conn->connect_error){
	...
	$sql = "INSERT INTO inventory (inventory_id, film_id, store_id, last_update) VALUES ('".$_POST["inid"]."','".$_POST["filmid"]."', '".$_POST["storeid"]."', '$date');";
	$sql .= "UPDATE inventory SET last_update='$date' WHERE inventory_id IS NOT NULL";
